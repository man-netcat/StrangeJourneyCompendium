...
class Reslvls
{
    ...
    public int getFir() { return this.fir; }

    public void setFir(int fir) { this.fir = fir; }

    private int ele;

    public int getEle() { return this.ele; }

    public void setEle(int ele) { this.ele = ele; }

    private int gun;

    public int getGun() { return this.gun; }

    public void setGun(int gun) { this.gun = gun; }

    private int ice;

    public int getIce() { return this.ice; }
    ...
    public int getPhy() { return this.phy; }
...
public class Demon
{
    ...
    public String getInherits() { return this.inherits; }
    ...
    public void setLvl(double lvl) { this.lvl = lvl; }

    private int pcoeff;

    public int getPcoeff() { return this.pcoeff; }

    public void setPcoeff(int pcoeff) { this.pcoeff = pcoeff; }
    ...
    public String getResists() { return this.resists; }

    public void setResists(String resists) { this.resists = resists; }
    ...
    public ArrayList<String> getSource() { return this.source; }

    public void setSource(ArrayList<String> source) { this.source = source; }
    ...
    public String getAilments() { return this.ailments; }

    public void setAilments(String ailments) { this.ailments = ailments; }

    private Reslvls reslvls;

    public Reslvls getReslvls() { return this.reslvls; }

    public void setReslvls(Reslvls reslvls) { this.reslvls = reslvls; }

    private Double hpmod;

    public Double getHpmod() { return this.hpmod; }

    public void setHpmod(Double hpmod) { this.hpmod = hpmod; }
}